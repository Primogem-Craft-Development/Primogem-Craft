	...
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
		...
		if (!itemstack.getOrCreateTag().getBoolean("daishanchu") && itemstack.getDamageValue() == 0) {
			...
			if (entity instanceof Player _player && !_player.level().isClientSide())
				_player.displayClientMessage(Component.literal("\u00A75\u300E\u5947\u7269\u300F\u00A7f\u7CBE\u786E\u4F18\u96C5\u7684\u4EE3\u7801\u00A7a\u4FEE\u590D\u5B8C\u6210"), false);
		...
		if (itemstack.getOrCreateTag().getBoolean("daima4_yixiufu")) {
			if (!(entity instanceof LivingEntity _livEnt16 && _livEnt16.hasEffect(PrimogemcraftModMobEffects.JINGQUEDAIMA.get()))) {
		...
		if (!itemstack.getOrCreateTag().getBoolean("daishanchu") && itemstack.getDamageValue() == itemstack.getMaxDamage()) {
			if (entity instanceof Player _player && !_player.level().isClientSide())
				_player.displayClientMessage(Component.literal("\u00A75\u300E\u5947\u7269\u300F\u00A7f\u7CBE\u786E\u4F18\u96C5\u7684\u4EE3\u7801\u00A7c\u5DF2\u8017\u5C3D\uFF01"), false);
			if (world instanceof Level _level) {
				if (!_level.isClientSide()) {
