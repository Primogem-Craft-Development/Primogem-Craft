...
public class Daima2shuxingProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
		...
		if (itemstack.getOrCreateTag().getBoolean("daima2_yixiufu")) {
			if (!(entity instanceof LivingEntity _livEnt16 && _livEnt16.hasEffect(PrimogemcraftModMobEffects.QIQIAODAIMAXIUFU.get()))) {
		...
		if (!itemstack.getOrCreateTag().getBoolean("daishanchu") && itemstack.getDamageValue() == itemstack.getMaxDamage()) {
			if (entity instanceof Player _player && !_player.level().isClientSide())
				_player.displayClientMessage(Component.literal("\u00A75\u300E\u5947\u7269\u300F\u00A79\u6709\u70B9\u8E4A\u8DF7\u7684\u4EE3\u7801\u00A7c\u5DF2\u8017\u5C3D\uFF01"), false);
			if (world instanceof Level _level) {
				if (!_level.isClientSide()) {
