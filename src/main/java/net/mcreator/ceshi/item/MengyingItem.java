...
public class MengyingItem extends Item {
	public MengyingItem() {
		super(new Item.Properties().durability(521).fireResistant().rarity(Rarity.EPIC));
	}

	@Override
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		super.appendHoverText(itemstack, world, list, flag);
		list.add(Component.literal("\u6301\u6709\u6B64\u7269\u54C1\u65F6\uFF0C\u5982\u679C\u5728\u00A7d\u8FC7\u53BB\u00A7f\u6548\u679C\u6301\u7EED\u671F\u95F4\u6B7B\u4EA1"));
		list.add(Component.literal("\u5219\u7ACB\u523B\u89E6\u53D1\u8FC7\u53BB\u6548\u679C"));
	}
